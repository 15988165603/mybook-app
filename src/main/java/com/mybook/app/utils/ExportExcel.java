...
import com.mybook.app.constants.DateConstant;
...
public final class ExportExcel {
    ...
    public static HttpHeaders headers(String fileName) {
        ...
        try {
            ...
            Logger.error(ExportExcel.class, "请求头转码异常", e);
        }
        return headers;
    }
    ...
    public static byte[] excelExport(Collection<?> dataList, Map<String, String> titleMap, String sheetName, String suffer) {
        // 初始化workbook
        Logger.info(ExportExcel.class, "初始化workbook===========>>>startTime=" + System.currentTimeMillis());
        initWorkbook(sheetName, suffer);
        Logger.info(ExportExcel.class, "初始化workbook===========>>>endTime=" + System.currentTimeMillis());
        // 表头行
    ...
    private static void initWorkbook(String sheetName, String suffer) {
        try {
            ...
            Logger.error(ExportExcel.class, "实例化工作文本对象失败", e);
        }
    }
    ...
    private static void createContentRow(Collection<?> dataList, Map<String, String> titleMap) {
        ...
        Logger.info(ExportExcel.class, "导出-数据映射开始时间===========>>>startTime=" + curr);
        try {
            ...
            Logger.error(ExportExcel.class, "读取对象内容失败", e);
        }
        long end = System.currentTimeMillis();
        Logger.info(ExportExcel.class, "导出-数据映射截止时间===========>>>endTime=" + end);
    }

    /**
     * 使用对象属性顺序型方式实现Excel导出
     * @param dataList  对象集合
    ...
    private static byte[] resultByteArray() {
        ...
        try {
            ...
            Logger.error(ExportExcel.class, "数据导出异常", e);
        } finally {
            try {
                os.close();
            } catch (IOException e) {
